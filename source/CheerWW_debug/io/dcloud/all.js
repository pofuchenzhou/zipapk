...
plus.console.time = function() {}, plus.console.timeEnd = function() {}), function(a) {
    ...
    function l(a, d, e, f) {
        ...
        return e = i(e), l = {
            ...
            d && d(b);
        }, k.lastPosition && e.maximumAge && new Date().getTime() - k.lastPosition.timestamp <= e.maximumAge ? a(k.lastPosition) :0 === e.timeout ? n({
            code:h.TIMEOUT,
            message:"timeout value in PositionOptions set to 0 and no cached Position object available, or cached Position object's age exceeds provided PositionOptions' maximumAge parameter."
        }) :(l.timer = 1 / 0 !== e.timeout ? j(n, e.timeout) :!0, f && (o = c.callbackId(m, n), 
        c.exec(b, "getCurrentPosition", [ o, e.enableHighAccuracy, e.maximumAge, e.coordsType, e.provider, e.geocode, e.timeout ]))), 
        l;
    }
    var k, b = "Geolocation", c = window.plus.bridge, d = window.plus.tools, e = {};
    h.PERMISSION_DENIED = 1, h.POSITION_UNAVAILABLE = 2, h.TIMEOUT = 3, h.UNKNOWN_ERROR = 4, 
    k = a.geolocation = {
        lastPosition:null,
    ...
    d.process = function(a) {
        ...
        e = b.className, b = a.ios.__Tool.New(b, !0), a.android.importClass(e), a.android.__runtimeMainActivity__ = b, 
        b);
    });
}(window.plus), function(a) {
    function f(a, e, f, g) {
